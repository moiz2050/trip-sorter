...
namespace Core\Library\TripSorter;

/**
 * Class TripSorter
 *
 * @package Core\Library\TripSorter
 */
class TripSorter
{
    ...
    protected static $transportation = array(
        'train' => 'Core\Library\TripSorter\Transportation\Train',
        'bus' => 'Core\Library\TripSorter\Transportation\Bus',
        'plane' => 'Core\Library\TripSorter\Transportation\Plane',
    );
